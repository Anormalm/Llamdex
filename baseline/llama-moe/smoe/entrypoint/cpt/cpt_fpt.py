...
def main():
    ...
    elif model_args.config_name == "mistral" or model_args.model_type == "mistral":
    ...
    if model_args.model_type == "mistral" or model_args.model_name_or_path == "mistral":
