...
def train_bank_marketing_gbdt(dataset_name, scaler=None, epsilon=None, delta=None):
    ...
    # Encode the subscribed labels
    le = LabelEncoder()
    train_df['subscribed'] = le.fit_transform(train_df['subscribed'])
    test_df['subscribed'] = le.transform(test_df['subscribed'])
...
if __name__ == '__main__':
    ...
    train_bank_marketing_gbdt("syn_bank_marketing", scaler)
    # train on clean data
    train_bank_marketing_gbdt("bank_marketing", scaler)
